...
public class TabPager_Adapter extends FragmentPagerAdapter {
    private String dari,nomor_surat,tanggal_surat,perihal,diterimaTgl,
            ...
            tgl_kirim_bupati,time_dokumen,id_jenis_dokumen,jenis_dokumen,sifat_dokumen,path_disposisi,path;
    ...
    public Fragment getItem(int i) {
        switch (i)
        {
            case 0: return Fg_dokumen.newInstance(this.path_file,this.path);
            case 1: return Fg_disposisi.newInstance(this.dari,this.nomor_surat,this.tanggal_surat,this.perihal,
                                                    ...
                                                    this.id_jenis_dokumen,this.jenis_dokumen,this.id_sifat_dokumen,this.sifat_dokumen);
        }
        return null;
    }
